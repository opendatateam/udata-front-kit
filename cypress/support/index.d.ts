import type { DatasetV2, DatasetV2WithFullObject } from '@datagouv/components-next'
...
declare global {
  namespace Cypress {
    interface Chainable {
      ...
      mockDatasetAndRelatedObjects(dataset: DatasetV2 | DatasetV2WithFullObject, resources?: object[], dataservices?: object[], reuses?: object[]): Chainable<void>
