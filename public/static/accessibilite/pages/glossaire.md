...
<dl>
	<dt>Donnée</dt>
	<dd>Une donnée est une information recueillie et enregistrée pour décrire quelque chose, comme un lieu, un service ou une situation.</dd>
	<dt>Données d'accessibilité</dt>
...
<dl>
	...
	<dd>Personne qui a une difficulté durable et qui peut rencontrer des obstacles dans la vie de tous les jours lorsque l’environnement n’est pas accessible.</dd>
	<dt>Personne à mobilité réduite (PMR)</dt>
...
<dl>
	<dt>Thème</dt>
	<dd>Un thème est une catégorie de classement utilisée pour regrouper et filtrer les jeux de données selon un point d’intérêt commun. Il permet aux utilisateurs d’explorer les données d’accessibilité par domaine de vie ou d’action publique.</dd>
</dl>
