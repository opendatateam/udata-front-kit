### Hackathon Données Ouvertes Météo-France : Venez valoriser les données publiques météorologiques !

<img src="https://static.data.gouv.fr/images/c6/b4f494d54c46e4af98f14712c8f703.png" style="width: 100%">

Collectées grâce à des stations au sol, des radars, etc. ou produites à partir de modèles numériques de prévision, les données météorologiques sont foisonnantes.
...
Il pourra s’agir de développer de nouveaux services, d’utiliser de l’intelligence artificielle, de créer des outils avancés de visualisation, de manipulation et d'accès aux données pour rendre les données météo plus accessibles et compréhensibles, etc.

**Une première liste de défis vous sera proposée pour le hackathon, mais vous serez libre de vous attaquer à toute autre problématique. Vous pouvez nous soumettre vos idées de défis dès à présent dans le formulaire d’inscription.**
...
**[Inscrivez-vous !](https://www.eventbrite.fr/e/billets-hackathon-donnees-ouvertes-meteo-france-836005554117)**
