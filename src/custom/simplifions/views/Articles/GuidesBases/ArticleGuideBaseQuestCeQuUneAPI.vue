<template>
  ...
  >
    ...
    <ArticleSection id="definition" label="Qu'est-ce qu'une API ?">
      ...
      <p>
       Dans le cas d'une démarche qui n'est pas simplifiée par l'utilisation d'API, lorsqu'un usager effectue la démarche, il lui est
        ...
        extrait Kbis…</i> 
        <br/>C'est sur lui que repose la charge de faire transiter ces données pourtant connue de l'administration.
      </p>
      ...
      <h3>Comment cela se concrêtise pour les usagers et les agents ?</h3>
    ...
    <ArticleSection id="api-entreprise-particulier" label="Les API clés pour la simplification">
      ...
      <p class="fr-text--lg">
        La mise en oeuvre du Dîtes-le nous une fois reposant en grande partie sur des échanges de données, différentes administrations mettent à disposition des API dédiées à cet objectif. 
      </p>
      ...
      >
        <p>
       L'utilisation de l'<b>API FranceConnect permet d'utiliser en données d'appel une connexion de l'usager via FranceConnect</b>. Les API proposant ce paramètre d'appel sont prénommées des « API FranceConnectées ».</p> 
     
        <router-link
        class="fr-btn fr-btn--secondary fr-icon-arrow-right-line fr-btn--icon-right"
       to="/guides/api-franceconnectees/les-apis-franceconnectees"
            >
    ...
    <ArticleSection id="recapitulatif" label="Récapitulatif">
      ...
      <SimplifionsArticleChecklist>
        ...
        <li>
          ...
          <router-link to="/solutions/franceconnect-2"><strong>FranceConnect</strong></router-link> pour utiliser une connexion usager comme donnée d'appel et accéder aux <router-link to="/guides/api-franceconnectees/les-apis-franceconnectees">API FranceConnectées</router-link>.
        </li>
      </SimplifionsArticleChecklist>
...
export const articleMeta = {
  ...
  articleTags: [{ label: 'Non-techniciens' }, { label: 'Petites collectivités' }],
...
import SimplifionsApiSireneDemo from './ApiSireneDemo.vue'
