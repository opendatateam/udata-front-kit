<template>
  <ul ref="track" class="carousel__track" @scroll.passive="onScroll">
    <slot />
  </ul>
  <div v-show="hasOverflow" class="fr-mt-2w fr-pb-2w fr-grid-row fr-grid-row--center">
    <button
      type="button"
...
const props = defineProps<{ onResize?: () => void }>()
